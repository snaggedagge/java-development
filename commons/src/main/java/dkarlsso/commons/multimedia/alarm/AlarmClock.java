...
//    private final Logger LOG = LogManager.getLogger(AlarmClock.class);
    ...
    private final List<AlarmTimeSetting> alarmTimeSettings;

    private boolean isRunning = true;

    public AlarmClock(final SoundController soundController, final MediaPlayer mediaPlayer, final List<AlarmTimeSetting> alarmTimeSettings) {
        this.alarmTimeSettings = alarmTimeSettings;
        this.soundController = soundController;
        this.mediaPlayer = mediaPlayer;
    }

    public AlarmClock(final SoundController soundController, final MediaPlayer mediaPlayer,final AlarmTimeSetting alarmTimeSetting) {
        this.alarmTimeSettings = Stream.of(alarmTimeSetting).collect(Collectors.toList());
        this.soundController = soundController;
        this.mediaPlayer = mediaPlayer;
    }
